...
| `Mathematics/` | CreatorEngine의 DirectX 계열 수학 타입·연산을 대체할 C++20/23 헤더 온리 라이브러리 | vcpkg 포트가 없고 빌드 중 네트워크 fetch를 허용하지 않는다. `v0.1.0` pre-release의 존재와 별개로 검토한 upstream HEAD `d81ca3338ef6f645cc5743625067eece5f1099f0`을 고정한다. 출처·갱신 절차는 [Mathematics/PROVENANCE.md](Mathematics/PROVENANCE.md) |
