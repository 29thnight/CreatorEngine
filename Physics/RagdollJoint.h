...
public:
	...
	bool Initialize(const RagdollLink* paranthLink, const RagdollLink* ownerLink, const JointInfo& info);
	...
	inline const physx::PxArticulationReducedCoordinate* GetPxJoint() const { return m_pxJoint; }
...
private:
	...
	physx::PxArticulationReducedCoordinate* m_pxJoint; //°üÀý
