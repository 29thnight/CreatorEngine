...
public:
	...
	void Initialize(Entity* owner,Mathf::Vector3 pos, int damage, float radius, float delay, bool itemDrop, bool useOrbiting = false,bool clockwise =true, bool is34 =false);
	void ShaderUpdate();
