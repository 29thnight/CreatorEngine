...
NodeStatus BP0013::Tick(float deltatime, BlackBoard& blackBoard)
{
    const auto MY_PATTERN_TYPE = TBoss1::EPatternType::BP0013; // 이 노드에 해당하는 패턴 타입
    ...
    {
        script->BP0013(); // 이 노드에 맞는 패턴 시작 함수 호출
