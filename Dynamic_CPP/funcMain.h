...
#pragma	endregion
	...
	EXPORT_API void InitModuleFactory()
	{
		...
		CreateFactory::GetInstance()->RegisterFactory("NewBehaviourScript1", []() { return new NewBehaviourScript1(); });
		CreateFactory::GetInstance()->RegisterFactory("NewBehaviourScript2", []() { return new NewBehaviourScript2(); });
