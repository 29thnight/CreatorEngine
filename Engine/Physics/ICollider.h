...
struct ICollider
{
	...
	//position offset
	virtual void SetPositionOffset(math::vector3 pos) = 0;
	virtual math::vector3 GetPositionOffset() = 0;
	
	//rotation offset
	virtual void SetRotationOffset(math::quaternion rotation) = 0;
	virtual math::quaternion GetRotationOffset() = 0;
