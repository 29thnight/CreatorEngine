...
// íŠ¸ëž™ C3 â€” SoundSystem ë“±ë¡/í•´ì§€. OnInitialized/OnUninitializing(ì»´í¬ë„ŒíŠ¸ë‹¹ 1íšŒ ê²Œì´íŠ¸)ì´
...
// (OnUninitializing) ì§ì „ì— OnRemovingFromSceneì„ ë¨¼ì € ë¶€ë¥´ë¯€ë¡œ, ì´ ì‹œìŠ¤í…œì—ì„œ
