...
namespace CommandCore
{
    namespace
    {
        ...
        constexpr DescriptorSeed kSeeds[] = {
            ...
            { "animator.scene.probe", CommandCost::Frames, "", "Animator 컨트롤러 그래프를 scene reflection YAML로 왕복시킨다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "asset.guid.rename.probe", CommandCost::Frames, "", "자산 GUID가 이름 변경을 건너 보존되는지 본다(재질 왕복 포함)", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "assets.generation", CommandCost::Long, "<project root>", "UUIDv8 model generation closure·원자 cache publish/retire 검증", CommandClass::EngineService, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "assets.generationcorpus", CommandCost::Long, "<content root>", "현재 MBC4 model corpus generation cold-load 검증", CommandClass::EngineService, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "assets.identity", CommandCost::Long, "", "자산 identity(UUID·epoch·프로필) 전수 계약을 판정한다", CommandClass::EngineService, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "assets.modelbench", CommandCost::Long, "<dir|-> <반복> [cooked|author]", "모델 로드·저작 트랜잭션 시간과 peak working set을 잰다", CommandClass::EngineService, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "assets.modelrender", CommandCost::Frames, "", "모델 렌더 배선(mesh·재질 해석)을 판정한다", CommandClass::EngineService, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "assets.sidecar", CommandCost::Long, "", "모델 sidecar v2 스키마를 전수로 판정한다", CommandClass::EngineService, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "experiment.animmask", CommandCost::Frames, "", "AvatarMask 트리 생성을 legacy 재귀와 A/B로 대조한다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "experiment.animpose", CommandCost::Frames, "<0..1> [클립]", "클립의 특정 지점 포즈를 고정 계산해 판정한다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "experiment.animtick", CommandCost::Frames, "", "Animator 틱 경로의 패리티를 판정한다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "experiment.boneresolve", CommandCost::Frames, "", "본 이름 해석 창구를 전수 A/B로 대조한다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "experiment.catalog", CommandCost::Frames, "[Derived부모]", "CEMF catalog — 전 GUID 해석·내용 검증·폐포 위상 순서", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "experiment.editorsurface", CommandCost::Frames, "", "에디터 표면 질의(클립 축·mesh 축)의 A/B 동치를 판정한다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "experiment.foliage", CommandCost::Frames, "seed <asset-directory> <model-path> | verify", "Foliage 메시의 experiment 핸들 합류를 합성으로 판정한다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "experiment.matcook", CommandCost::Long, "[루트 재질 모델]", "재질 의존 폐포 — standalone 재질 + 모델의 임베디드 texture 추출", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "experiment.matruntime", CommandCost::Frames, "[edit | seed <asset-directory> <texture-path>]", "런타임 MaterialInstance 경로를 판정한다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "experiment.scenecook", CommandCost::Long, "[루트 씬]", "scene/prefab 의존 추출 — 자기참조 제외·못 그린 참조 계수", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "experiment.skinbounds", CommandCost::Frames, "", "스킨 팔레트의 유한성·인덱스 범위·크기 상한을 판정한다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "reflect.golden", CommandCost::Long, "[출력 경로]", "등록된 전 타입의 직렬화 출력을 골든 문서로 쓴다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "rhi.uploadsegments", CommandCost::Frames, "<model-path> <texture-path>", "DX12/Vulkan 완료점 기반 업로드 세그먼트 공통 검증", CommandClass::Probe, CommandLiveness::RequiresRestart, false, CommandRoles::Editor, "", false, true },
            ...
            { "scene.executiongraph", CommandCost::Frames, "probe|bench <N> [samples]", "X4 packed projection 불변식·compile 비용 검사", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "scene.hierarchymutation", CommandCost::Frames, "probe", "X3 reparent 검증·대칭성·topology version 검사", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "scene.proxybench", CommandCost::Long, "<프레임수> [등록수]", "X8 정지 dirty-queue 커밋 비용(선택: 합성 등록수)", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "scene.proxydirty", CommandCost::Frames, "probe", "X8 frame-persistent render dirty mask·generation 검사", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "scene.sparseresolver.check", CommandCost::Long, "probe|bench [arguments]", "Scoped transform regression", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "scene.transformbulk", CommandCost::Frames, "probe <pose-model-path> <rebind-model-path>", "X7 Animator pose·Physics world batch·Socket barrier 검사", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "scene.transformdomains", CommandCost::Frames, "probe", "X2 UI/Spatial 독립 dirty gate·paused/subtree 검사", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "scene.transformpull", CommandCost::Frames, "[print]", "X6 C# 즉시 pull 계측 스냅샷을 조회한다", CommandClass::EngineService, CommandLiveness::Live },
            { "scene.transformpull.check", CommandCost::Long, "probe", "Scoped transform regression", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "scene.transformwritestats.check", CommandCost::Long, "probe", "Scoped transform regression", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "scene.traversalbench", CommandCost::Long, "<오브젝트수> <프레임수> [flat|wide|deep|skeleton]", "X0 Release 벤치(0=현재 씬)", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "serialize.bench", CommandCost::Long, "boot | scene <경로> [반복] | prefab <이름> [반복]", "직렬화 경로별 시간을 잰다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "serialize.nodeequal", CommandCost::Frames, "", "저작 노드 구조 비교 규칙을 판정한다(맵 키 순서 무시가 의도)", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "serialize.rymlerror", CommandCost::Frames, "", "ryml 에러 정책이 abort를 막는지 판정한다", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "vk.fog", CommandCost::Frames, "", "VolumetricFog 공용 패스 — 3D scatter/history/composite 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "vk.gizmoicon", CommandCost::Frames, "", "실제 Camera Gizmo PNG — 2D SRV·root instance 픽셀 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.gizmoline", CommandCost::Frames, "", "GizmoLine 공용 패스 — line-list 전체 RGBA DX12/Vulkan 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            ...
            { "vk.ibl", CommandCost::Frames, "", "IBL 생성기를 Vulkan 으로 — 면·밉·LUT DX12 픽셀 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.parallel", CommandCost::Frames, "", "Vulkan RenderGraph 병렬 command pool·제출·픽셀 검증", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.post", CommandCost::Frames, "", "PostChain 공용 패스 — bloom/tonemap/vignette/FXAA 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.selftest", CommandCost::Frames, "<model-path> <texture-path> [output]", "Vulkan 골격 자가 검증(디바이스·중립 서비스 경로·스왑체인 → PNG)", CommandClass::Probe, CommandLiveness::RequiresRestart, false, CommandRoles::Editor, "", false, true },
            ...
            { "vk.skybox", CommandCost::Frames, "", "스카이박스를 Vulkan 으로 — 큐브 SRV·정적 샘플러 픽셀 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.ssao", CommandCost::Frames, "", "SSAO 공용 패스 — depth/normal compute·filter DX12/Vulkan 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.ssgi", CommandCost::Frames, "", "SSGI 공용 패스 — Hi-Z·temporal·filter·composite 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.ssr", CommandCost::Frames, "", "SSR 공용 패스 — ray hit·metal/thickness/bitmask 픽셀 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.sss", CommandCost::Frames, "", "SSS 공용 패스 — 2축 blur·depth gate 전체 픽셀 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.ui", CommandCost::Frames, "", "UI 공용 패스 — layer·blend·texture batch DX12/Vulkan 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
            { "vk.wireframe", CommandCost::Frames, "", "WireFrame 공용 패스 — non-solid fill·skinning DX12/Vulkan 대조", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
