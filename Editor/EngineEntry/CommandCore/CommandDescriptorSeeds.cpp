...
namespace CommandCore
{
    namespace
    {
        ...
        constexpr DescriptorSeed kSeeds[] = {
            ...
            { "editor.inspector", CommandCost::Immediate, "[width <논리 px>|off|expand on|off|fixture on|off]", "인스펙터 본문 폭·접힘 머리 펼침·리플렉션 자극물을 정하고 본문마다 공통 배치 줄 수와 가로 넘침을 읽는다", CommandClass::EditorOperation, CommandLiveness::Live, false, CommandRoles::Editor, "" },
            ...
            { "vk.parallel", CommandCost::Frames, "", "Vulkan 공용 Job 명령 기록·수명·픽셀 검증", CommandClass::Probe, CommandLiveness::Live, false, CommandRoles::Editor, "", false, true },
