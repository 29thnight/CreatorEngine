...
namespace CommandCore
{
    namespace
    {
        ...
        constexpr DescriptorSeed kSeeds[] = {
            ...
            { "editor.inspector", CommandCost::Immediate, "[width <논리 px>|off|expand on|off]", "인스펙터 본문 폭·접힘 머리 펼침을 정하고 본문마다 공통 배치 줄 수와 가로 넘침을 읽는다", CommandClass::EditorOperation, CommandLiveness::Live, false, CommandRoles::Editor, "" },
