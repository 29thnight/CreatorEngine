...
namespace CommandCore
{
    namespace
    {
        ...
        constexpr DescriptorSeed kSeeds[] = {
            ...
            { "dump.crash", CommandCost::Immediate, "<access|abort|terminate|throw>", "일부러 죽여 크래시 덤프 경로를 검증한다", CommandClass::Probe, CommandLiveness::TerminatesProcess },
            ...
            { "experiment.normal", CommandCost::Frames, "", "평면 법선 합성 검사(감김·면 분리·퇴화 처리, 자산 무관)", CommandClass::Probe, CommandLiveness::Live },
            { "experiment.resolver", CommandCost::Frames, "", "CookedThenSource resolver — 호출 순서와 폴백 관측(자산 무관)", CommandClass::Probe, CommandLiveness::Live },
            { "experiment.sampler", CommandCost::Frames, "", "보간 합성 검사(Step/Linear 계단·강등·키 뭉침, 자산 무관)", CommandClass::Probe, CommandLiveness::Live },
            ...
            { "experiment.tangent", CommandCost::Frames, "", "탄젠트 합성 검사(mikktspace 축·handedness·이음매 분리, 자산 무관)", CommandClass::Probe, CommandLiveness::Live },
            ...
            { "experiment.weld", CommandCost::Frames, "", "정점 용접 — 합치는가/안 합치는가(실자산은 0건이라 이것만이 증거다)", CommandClass::Probe, CommandLiveness::Live },
