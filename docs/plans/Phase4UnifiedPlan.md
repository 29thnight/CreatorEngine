...
| T0 `I6-B3~E2` | **24일** (2026-09-01 재산정 · 옛 5일의 **5배**) | 접촉 259건 전수 · B4 착지 뒤 재측정 |
| T1 | 11일 | |
| T2~T4 `RG1~RG9` | 113일 | RG0 4일이 BASE-0으로 이동 |
| T4 `Q0` | **재산정** | RG8 25일에서 분리 |
| T6 `L1~L7` | 33일 | |
| T7 설계 게이트 | 6.5일 | |
| **세어진 합** | **188.5일 + 재산정 1건(`Q0`)** | I6 재산정 반영(+19일) |
| **§8 미산정 백로그** | **16슬라이스 · 미산정** | SRP-0~6 · PBR-S0~S8 |

대시보드의 기존 합계 **226일은 세 곳에서 실제와 다르다** — ① 완료분 33일이 잔여로
잡혀 있고, ② `V4`·`V6` 7일이 이중·유령이고, ③ SRP/PBR-S 16슬라이스가 0일이다.
