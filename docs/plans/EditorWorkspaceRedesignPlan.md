...
| W2 | progress | 4종 구현은 완료. **키보드 탐색은 W2-1, 잘라 그리기·tooltip 은 W2-2, 상태 행렬은 W2-3 으로 착지**(2026-09-15 — 세 절 모두 판정문에 자가 없었다. nav 커서는 넷 중 셋이 안 그렸고, 자르기는 넷 중 하나만 온전히 알고 있었고, 일곱 상태를 한자리에서 볼 수단은 0 이었다). 시각 기준선과 성능 gate 가 남는다 |
