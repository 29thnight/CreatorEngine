...
ForwardPass::ForwardPass()
{
	...
	InputLayOutContainer instanceVertexLayoutDesc2 = {
	{ "POSITION",     0, DXGI_FORMAT_R32G32B32_FLOAT,    0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "NORMAL",       0, DXGI_FORMAT_R32G32B32_FLOAT,    0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD",     0, DXGI_FORMAT_R32G32_FLOAT,       0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD",     1, DXGI_FORMAT_R32G32_FLOAT,       0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	...
	m_instanceFoliagePSO->CreateInputLayout(std::move(instanceVertexLayoutDesc2));
	...
	for(auto& proxy : data->m_foliageQueue)
	{
		...
		for(auto& [key, instances] : proxy->instanceMap)
		{
			...
			for (size_t base = 0; base < total; base += kMaxInstancesPerDraw)
			{
				...
				// m_instanceBuffer: �ν��Ͻ̿� VB (DEFAULT ����)
