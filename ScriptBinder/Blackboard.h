...
public:
	...
	// ?‰íƒ„?”ìš© ?½ê¸° ?‘ê·¼??(PHASE 9-8 B7).
	// ?°í???ê°??Œìœ ??ê´€ë¦?ì¸¡ìœ¼ë¡?ê°”ê³ , ???´ë˜?¤ëŠ” ?€?‘Â·ì§?¬í™” ?„ìš©???ë‹¤.
	// ?¸ë¦¬ë¥?ë§Œë“¤ ???€??ê°’ì„ ??ë²??¤ì–´ ë³´ë‚´ê¸??„í•´ ?„ì²´ë¥?ë³????ˆì–´???œë‹¤.
...
private:
	...
	//Core::Delegate<void, const std::string&> m_valueChangedDelegate; // °ª º¯°æ¿¡ ´ëÇÑ µ¨¸®°ÔÀÌÆ®
