...
// íŠ¸ë™ C3 â€” AnimatorSystem ë“±ë¡/í•´ì§€. Awake/OnDestroy(ì»´í¬ë„ŒíŠ¸ë‹¹ 1íšŒ ê²Œì´íŠ¸)ê°€
// ì•„ë‹ˆë¼ ì”¬ í¸ì…/ì´íƒˆ í›…ì„ ì“°ëŠ” ì´ìœ ëŠ” AnimatorSystem.h ìƒë‹¨ ì£¼ì„ ì°¸ì¡° â€” DDOL
// ì˜¤ë¸Œì íŠ¸ê°€ ì”¬ì„ ê±´ë„ ë•Œë„ ë§¤ë²ˆ ë‹¤ì‹œ ë¶ˆë ¤ì•¼ í•˜ê¸° ë•Œë¬¸ì´ë‹¤. ì‹¤ì œ íŒŒê´´ ê²½ë¡œ
// (Scene::FlushPendingDestroy)ë„ OnUninitializing(ìœ„ OnDestroy ë¸Œë¦¬ì§€) ì§ì „ì—
// OnRemovingFromSceneì„ ë¨¼ì € ë¶€ë¥´ë¯€ë¡œ, ì´ ì‹œìŠ¤í…œì—ì„œ ë¹ ì§€ëŠ” ì‹œì ì´ í•­ìƒ ì‹¤
// íŒŒê´´ë³´ë‹¤ ë¨¼ì €ë‹¤.
...
{
	// CT6-d: êµ¬ ComponentFactory Animator ë¶„ê¸° ì´ë™(ë™ì‘Â·ìˆœì„œ ë³´ì¡´).
	// ParametersÂ·m_animationControllersëŠ” í¬ì¸í„° ì›ì†Œ ë²¡í„°ë¼ typed ì—­ì§ë ¬í™”ê°€
	// ê±´ë“œë¦¬ì§€ ì•ŠëŠ”ë‹¤ â€” ì—¬ê¸°ì˜ ìˆ˜ë™ ë³µì›ì´ ì‹¤ì±„ì›€ì´ë‹¤.
	Model* model = nullptr;
